...
void Menu::pong(){
  ...
  this->display->solidCr(50,50,50,0,0,0,this->display->shape[1]-1);
  this->display->solidCr(50,50,50,this->display->shape[0]-1,0,this->display->shape[0]-1,this->display->shape[1]-1);
